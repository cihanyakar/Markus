...
internal static class IconData
{
    ...
    public static StreamGeometry Eye { get; } =
        StreamGeometry.Parse(
            "M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9M12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17M12,4.5C7,4.5 2.73,7.61 1,12C2.73,16.39 7,19.5 12,19.5C17,19.5 21.27,16.39 23,12C21.27,7.61 17,4.5 12,4.5Z"
        );

    public static StreamGeometry Pencil { get; } =
        StreamGeometry.Parse(
    ...
    public static StreamGeometry ContentSave { get; } =
        StreamGeometry.Parse(
            "M17,3H5A2,2 0 0,0 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V7L17,3M12,19A3,3 0 0,1 9,16A3,3 0 0,1 12,13A3,3 0 0,1 15,16A3,3 0 0,1 12,19M6,5H15V9H6V5Z"
        );
