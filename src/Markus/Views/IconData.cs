...
internal static class IconData
{
    ...
    public static StreamGeometry Palette { get; } =
        StreamGeometry.Parse(
            "M12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2C17.5,2 22,6 22,11A6,6 0 0,1 16,17H14.2C13.9,17 13.7,17.2 13.7,17.5C13.7,17.6 13.8,17.7 13.8,17.8C14.2,18.3 14.4,18.9 14.4,19.5C14.5,20.9 13.4,22 12,22M5.5,12A1.5,1.5 0 0,0 4,13.5A1.5,1.5 0 0,0 5.5,15A1.5,1.5 0 0,0 7,13.5A1.5,1.5 0 0,0 5.5,12M9.5,7A1.5,1.5 0 0,0 8,8.5A1.5,1.5 0 0,0 9.5,10A1.5,1.5 0 0,0 11,8.5A1.5,1.5 0 0,0 9.5,7M14.5,7A1.5,1.5 0 0,0 13,8.5A1.5,1.5 0 0,0 14.5,10A1.5,1.5 0 0,0 16,8.5A1.5,1.5 0 0,0 14.5,7M18.5,12A1.5,1.5 0 0,0 17,13.5A1.5,1.5 0 0,0 18.5,15A1.5,1.5 0 0,0 20,13.5A1.5,1.5 0 0,0 18.5,12Z"
        );

    public static StreamGeometry ViewQuilt { get; } =
        StreamGeometry.Parse("M10,18H3V13H10V18M10,11H3V6H10V11M11,11H21V6H11V11M11,18H21V13H11V18Z");
